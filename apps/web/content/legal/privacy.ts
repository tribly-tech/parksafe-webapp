  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        'Communication metadata: SMS/WhatsApp/call routing data processed by our messaging partners to deliver alerts.',
        'Settings and preferences: notification toggles (SMS, WhatsApp, marketing emails).',
    ...
    },
    {
      ...
      bullets: [
        'Messaging and telecom providers: to send SMS, WhatsApp, or call notifications (they process data under their own policies).',
